...
//---- Setting Upper/Lower or Open/Close Points
   ...
   if(inpPrice==PM_LowHigh)
     {
      ExtUpperStopBuffer[i]=iFractals(NULL,UpperPeriod,MODE_UPPER,i);
      ExtLowerStopBuffer[i]=iFractals(NULL,UpperPeriod,MODE_LOWER,i);      
      if(ExtUpperStopBuffer[i]=0)
         ExtUpperStopBuffer[i]=ExtUpperStopBuffer[i+1];
      if(ExtLowerStopBuffer[i]=0)
         ExtLowerStopBuffer[i]=ExtLowerStopBuffer[i+1];         
